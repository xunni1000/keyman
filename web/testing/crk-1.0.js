...
function Keyboard_us() {
    ...
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "", "w", "ê", "r", "t", "y", "ô", "i", "o", "p", "[", "]", "\\", "", "", "", "a", "s", "", "", "", "h", "î", "k", "l", ";", "'", "", "", "", "", "", "\\", "â", "", "c", "", "", "n", "m", ",", ".", "/", "", "", "", "", "", " ", "~", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "", "", "", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "{", "}", "|", "", "", "", "A", "S", "D", "F", "G", "H", "J", "K", "L", ":", "\"", "", "", "", "", "", "|", "Z", "X", "C", "V", "B", "N", "M", "<", ">", "?", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
